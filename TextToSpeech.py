...
def main():
    ...
    parser.add_argument('--ref-file',
                        default='Audio/Reference/voice_preview_myrddin - magical narrator & wise mentor.mp3',
                        help='Path to reference audio file (default: Audio/Reference/voice_preview_myrddin - magical narrator & wise mentor.mp3)')
    parser.add_argument('--ref-text',
                        default='Through the mists of time, I\'ve discovered that dragons are remarkably ticklish behind their ears. Though, I would not recommend testing this theory.',
